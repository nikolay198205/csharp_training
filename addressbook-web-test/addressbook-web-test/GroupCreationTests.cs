...
{  
    [TestFixture]
    public class GroupCreationTests //Класс для проверки правильности создания групп
    {
        private IWebDriver driver; //поле содержит данные
        private StringBuilder verificationErrors; //поле
        private string baseURL; //поле
        ...
        public void GroupCreationTest() //тестовый метод
        {
            ...
            driver.FindElement(By.Name("group_footer")).SendKeys("twest1");
